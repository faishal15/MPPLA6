...
$result = mysqli_query($conn, "SELECT * FROM barang where Kategori='Ditemukan' order by ID_Barang desc limit $start_from,$batas");
            ...
            <h1>LIST BARANG TEMUAN</h1>
                <div class="row">
                    ...
                    <div class="row text-center">
                        <div class="col-lg-12">
                            <?php  
                            $sql = "SELECT COUNT(ID_Barang) FROM barang where Kategori='Ditemukan'";  
                            ...
                            for ($i=1; $i<=$total_pages; $i++) { 
                               $pagLink .= "<li><a href='listtemu.php?page=".$i."'>".$i."</a></li>";  
                           };  
                           echo $pagLink . "</ul>";  
                           ?>
                        </div>
