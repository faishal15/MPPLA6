                ...
                action="?act=upd<?php echo ($editid!="") ? "&editid=$editid":"";  ?>" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" name="i_ket" rows="5" required><?php echo htmlspecialchars($p_keterangan); ?></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input name="i_pemilik" type="number" class="form-control" placeholder="Masukkan ID Penemu berupa angka">
									</div>
								</div>
