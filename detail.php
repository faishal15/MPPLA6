...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="about" class="container content-section text-left">
        <div class="row">
            ...
            <div class="modal" id="<?php echo $ID_User?>" >
                <div class="modal-dialog">
                  <div class="modal-content animate">
                    <div class="modal-header">
                    ...
                    <div class="col-md-9">
                    <input name="i_receiver" type="text" class="form-control" value="<?php echo $ID_User?>" style="width:100%;" required>
                    </div>
                    </div>
                    ...
                    <div class="col-md-9"><input name="i_secure" value="<?php echo $Security?>" class="form-control" style="width:100%;">
                    </div>
                    </div>
                    <br><br>
                    <div class="col-md-12">
